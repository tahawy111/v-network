...
export default function Header({ }: HeaderProps) {
  ...
  return <nav className={ `w-full bg-main text-white flex md:items-center` }>
    ...
    <div className="flex justify-between items-start w-full flex-col gap-3 m-3 md:flex-row md:items-center md:mx-auto container">
      ...
      <ul className={ `bg-main md:gap-3 gap-0 items-center md:justify-normal justify-evenly flex md:static fixed bottom-0 left-0 w-full md:w-fit shadow-sm shadow-black p-2 dark:shadow-white md:shadow-none` }>
        <li>
